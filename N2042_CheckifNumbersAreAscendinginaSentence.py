...
class Solution(object):
    def areNumbersAscending(self, s):
        ...
        easy 5 min, string.isnumeric() function to check if string is numeric.

        thought: split word and numbers, strip the numbers into an array,
        check if they are strictly increasing.

        01/31/2022 14:33	Accepted	42 ms	13.5 MB	python
        """
