...
class Solution(object):
    def sortJumbled(self, mapping, nums):
        ...
        thought: custom sort. sort by converted number
        python sort is stable: https://docs.python.org/2.7/howto/sorting.html
        ...
        07/22/2022 11:38	Accepted	3064 ms	19.5 MB	python
        medium - easy.
        custom sort
        10-20 min.
        """
