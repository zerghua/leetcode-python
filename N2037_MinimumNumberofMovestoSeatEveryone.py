...
class Solution(object):
    def minMovesToSeat(self, seats, students):
        ...
        easy 2 min. sort and compare.

        thought: sort both array, and do a sum(abs(a[i]-b[i])).

        02/01/2022 12:31	Accepted	52 ms	13.6 MB	python
        """
        ...
        ret = 0
        for i in range(n):
            ret += abs(sorted_students[i] - sorted_seats[i])
