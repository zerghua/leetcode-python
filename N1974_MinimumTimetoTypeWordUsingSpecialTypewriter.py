...
pointer is pointing to that character. The pointer is initially
...
class Solution(object):
    def minTimeToType(self, word):
        ...
        easy 5 -10min.
        thought: dist = abs(index[i] - index[j]), min_dist = min(dist, 26 - dist)
        use ord('c') - ord('b') to do subtraction of chars in python.

        03/21/2022 11:39	Accepted	16 ms	13.7 MB	python
        missed the problem description each type will take 1 second.
